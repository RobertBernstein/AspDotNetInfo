...
namespace AspDotNetInfo
{
    ...
    public partial class AspDotNetInfo : System.Web.UI.Page
    {
        ...
        private string GetDotNetVersionFromEnvironment()
        {
            ...
            try
            {
                dotNetVersionFromEnvironmentVariable = this.DotNetVersions[Environment.Version.ToString().Trim()] + " (" + Environment.Version.ToString().Trim() + ")";
            }
            catch (Exception)
            {
        ...
        protected string GetDotNetVersionFromMscorcfgDll()
        {
            ...
            {
                this.DisplayErrorMessage("Error: Version " + mscorcfgVersionNumber + " was not found in the list of known .NET versions.<br />Exception: " + ex.Message);
            }
        ...
        protected string GetDotNetVersionFromSystemCoreFile()
        {
            ...
            {
                this.DisplayErrorMessage("Error: Version " + systemCoreVersionNumber + " was not found in the list of known .NET versions.<br />Exception: " + ex.Message);
            }
        ...
        protected Dictionary<string, string> DotNetVersions = new Dictionary<string, string>
                                                                  {
                                                                      ...
                                                                      { "4.0.11001.1", "4.0 CTP, Oct 2008" },
                                                                      { "4.0.20506.1", "4.0 Beta 1, May 2009" },
                                                                      { "4.0.21006.1", "4.0 Beta 2, Oct 2009" },
                                                                      {
                                                                          "4.0.30128.1", "4.0 Release Candidate, Feb 2010"
                                                                      },
                                                                      { "4.0.30319.1", "4.0 RTM Release, April 2010" }
                                                                  };
    }
}